...
2. **Folic acid:** Look for an amount in parentheses after **Folate**. The label lists total folate in **mcg DFE**, but the parenthetical **mcg folic acid** is the number to compare with ACOG's recommendation of at least 400 mcg of folic acid in a daily prenatal around conception and early pregnancy. If no folic acid amount appears, do not assume the DFE amount is folic acid. See our [folate and folic acid guide](/blog/folate-folic-acid-pregnancy/).
...
The [FDA explains](https://www.fda.gov/food/nutrition-facts-label/folate-and-folic-acid-nutrition-and-supplement-facts-labels) that **mcg DFE** (dietary folate equivalents) accounts for the different absorption of food folate and added folic acid. If a label reads **Folate 680 mcg DFE (400 mcg folic acid)**, the two numbers describe different measures of the folate in that serving. For the folic acid check above, read the **400 mcg in parentheses**, not the 680 mcg DFE.
...
No. More is not automatically better, and stacking products can raise the risk of excessive intake. Ask your prenatal clinician about an additional supplement before taking one.

### What if my gummy has no iron?

Check the full label. If it has no iron, discuss your food intake and lab results with your clinician rather than adding iron by default.

### What if my prenatal has no iodine or choline?

Use the label as a conversation starter. Food choices and any added supplement should reflect your diet, health history, and clinician's guidance.

### Can I replace my prenatal with a food tracker?
