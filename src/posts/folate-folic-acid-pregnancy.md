---
title: "Folate Foods and Folic Acid During Pregnancy"
description: Compare folate in everyday portions of spinach, lentils, and avocado, and learn how food folate differs from folic acid on prenatal and cereal labels.
layout: post.njk
...
<figure class="post-image"><img src="/resource/portions/portion-spinach-100g.webp" srcset="/resource/portions/portion-spinach-100g-600.webp 600w, /resource/portions/portion-spinach-100g.webp 900w" sizes="(max-width: 720px) calc(100vw - 104px), 792px" alt="Illustration of fresh spinach leaves" width="900" height="900" loading="eager" fetchpriority="high"><figcaption>Illustrative food image; not a measured serving.</figcaption></figure>
...
NIH lists **600 mcg DFE per day** as the pregnancy folate reference. That total-folate measure is different from ACOG's recommendation for **at least 400 mcg of folic acid** in a daily prenatal before and during early pregnancy. Do not compare those two numbers as if they were the same unit and form.
...
### What do everyday portions provide?

| Food as prepared | Portion | Approximate folate |
| --- | --- | ---: |
| [Raw spinach](/food/11457-spinach-raw/) | 1 cup | **58 mcg DFE** |
| [Boiled lentils](/food/16070-lentils-mature-seeds-boiled/) | ½ cup | **179 mcg DFE** |
| [Raw avocado](/food/09037-avocados-raw/) | ½ cup sliced | **59 mcg DFE** |

The [NIH folate food table](https://ods.od.nih.gov/factsheets/Folate-HealthProfessional/) provides the spinach and avocado portions. The lentil estimate uses PregNut's **181 mcg DFE per 100 g** and the [USDA's 198 g per cooked cup](https://ods.od.nih.gov/pubs/usdandb/Folate-Food.pdf), so ½ cup is about 99 g. These are food-folate comparisons, not amounts of added folic acid. Actual servings and preparation can differ.

## Common questions

### Can I use folate-rich foods instead of a prenatal vitamin?

Do not assume so. ACOG notes that getting enough folic acid from food alone is difficult and recommends a prenatal supplement. If a prenatal causes side effects or you have trouble taking it, ask your clinician about alternatives.

### When should I start folic acid?

ACOG advises starting at least one month before pregnancy when possible. If you are already pregnant, discuss starting or continuing your prenatal with your care team now; there is no reason to delay while trying to perfect your diet.

### Is a fortified cereal the same as a serving of spinach?

They may contain different forms and amounts of the vitamin, and portions differ. On a fortified cereal's Nutrition Facts panel, read **Folate in mcg DFE** and, if folic acid was added, **folic acid in mcg in parentheses**. The general food-label **%DV uses 400 mcg DFE**, while the pregnancy folate reference is **600 mcg DFE**. The folic acid amount in parentheses answers a different question than either percentage. [FDA explains the label format](https://www.fda.gov/food/nutrition-facts-label/folate-and-folic-acid-nutrition-and-supplement-facts-labels).

### What if I have had a pregnancy affected by a neural tube defect?
...
**Sources:** [ACOG healthy eating during pregnancy](https://www.acog.org/womens-health/faqs/healthy-eating-during-pregnancy), [NIH folate fact sheet](https://ods.od.nih.gov/factsheets/Folate-Consumer/), [NIH food table](https://ods.od.nih.gov/factsheets/Folate-HealthProfessional/), [USDA Standard Reference serving weights](https://ods.od.nih.gov/pubs/usdandb/Folate-Food.pdf), and [FDA folate labeling](https://www.fda.gov/food/nutrition-facts-label/folate-and-folic-acid-nutrition-and-supplement-facts-labels). This guide is educational and does not replace prenatal care.
