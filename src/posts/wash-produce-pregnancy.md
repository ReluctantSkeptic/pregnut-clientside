...
ogType: article
schemaType: Article
socialImage: /resource/portions/portion-apple-100g.webp
...
<figure class="post-image"><img src="/resource/portions/portion-apple-100g.webp" alt="Illustration of sliced apple" width="900" height="900" loading="eager" fetchpriority="high"><figcaption>Illustrative food image; not a measured serving.</figcaption></figure>
...
Keep produce you will eat raw separate from raw meat, poultry, and seafood. Wash the cutting board, knife, and counter between those foods and ready-to-eat produce. Refrigerate perishable produce, including berries and leafy greens, at **40°F (4°C) or below**, and buy pre-cut produce only when it is refrigerated or on ice. These steps come from [FDA's produce-handling guide](https://www.fda.gov/food/buy-store-serve-safe-food/selecting-and-serving-produce-safely).

## Does a pre-washed salad need another rinse?

If the package says the greens are **pre-washed** or **ready-to-eat**, FDA says you can use them without washing again. If you choose to rinse them, keep them away from unclean surfaces and utensils so the extra handling does not introduce contamination. Store packaged or pre-cut produce in the refrigerator and follow the product's storage instructions. See the [FDA guidance on pre-washed produce](https://www.fda.gov/food/buy-store-serve-safe-food/selecting-and-serving-produce-safely).

## What about berries, melon, and cut fruit?

Rinse berries and other fresh fruit under running water before eating or preparing them. Wash a melon's rind and scrub it with a clean produce brush **before cutting**, even though you do not eat the rind. FDA notes that cutting can carry contamination from the outside to the inside.

[CDC's pregnancy food-safety table](https://www.cdc.gov/food-safety/foods/pregnant-women.html) says cut melon left out for more than **2 hours** is a riskier choice; use **1 hour** when it is exposed to temperatures above **90°F (32°C)**. It lists freshly cut melon or cut melon kept refrigerated for **7 or fewer days** as safer choices. If storage time or temperature is uncertain, do not use a nutrient chart to make the safety decision.

## Are raw sprouts handled the same way?
