...
const entries = [
  ...
  { id: "Riboflavin", label: "Vitamin B2 (riboflavin)", role: "Helps turn food into energy and supports cell growth and function.", source: "https://ods.od.nih.gov/factsheets/Riboflavin-Consumer/", guide: "/blog/riboflavin-without-dairy-pregnancy/" },
  { id: "Vitamin B-6", label: "Vitamin B6", role: "Helps the body use protein and supports nervous system development and function.", source: "https://ods.od.nih.gov/factsheets/Pregnancy-HealthProfessional/", guide: "/blog/vitamin-b6-foods-pregnancy/" },
  ...
  { id: "Vitamin C", label: "Vitamin C", role: "Helps make collagen and improves absorption of iron from plant foods.", source: "https://ods.od.nih.gov/factsheets/VitaminC-HealthProfessional/", guide: "/blog/vitamin-c-without-citrus-pregnancy/" },
