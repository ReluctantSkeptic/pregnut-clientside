...
const entries = [
  ...
  { id: "Iodine", label: "Iodine", role: "Needed to make thyroid hormones that support fetal brain development.", source: "https://ods.od.nih.gov/factsheets/Pregnancy-HealthProfessional/" },
  ...
  { id: "Potassium", label: "Potassium", role: "Supports normal cell function, fluid balance, and nerve and muscle activity.", source: "https://ods.od.nih.gov/factsheets/Potassium-HealthProfessional/" },
  { id: "Protein", label: "Protein", role: "Supplies amino acids for maternal and fetal tissue growth. PregNut's 70 g amount is a comparison benchmark; individual needs vary.", source: "https://www.acog.org/womens-health/faqs/healthy-eating-during-pregnancy" },
  ...
  { id: "Vitamin B-12", label: "Vitamin B12", role: "Supports nerve function, red blood cell formation, and DNA synthesis.", source: "https://ods.od.nih.gov/factsheets/VitaminB12-HealthProfessional/" },
